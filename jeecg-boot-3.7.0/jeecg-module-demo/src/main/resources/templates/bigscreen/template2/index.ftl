<!DOCTYPE html>
<#assign base=springMacroRequestContext.getContextUrl("") + "/jccj" >
<html lang="en">
...
<#--                    </div>-->
                    <div class="select" tabindex="0" hidefocus="true">
                        ...
                        <ul class="select-ul company">
                            <li class="active" data-value="">模板</li>
                            <li data-value="1">房屋采集</li>
                            <li data-value="2">人口采集</li>
                            <li data-value="2">单位采集</li>
                        </ul>
                    </div>
<#--                    <div class="select" tabindex="0" hidefocus="true">-->
<#--                        <div class="select-div">-->
...
<#--                    </tr>-->
        ...
        <div class="right-center">
            <div class="title-box">
                <p id="switchBtn"><span class="active" data-dataType="income">采集数据</span><img class="line-img" src="${base}/bigscreen/template2/images/line-blue.png" alt=""><!-- <span data-dataType="expend">未采集数据</span>--></p>
                <img class="line-img" src="${base}/bigscreen/template2/images/line-blue.png" alt="">
                <button id="dateBtn"><img src="${base}/bigscreen/template2/images/data_icon.png" alt="">日期</button>
            </div>
            <div class="data-box">
                <p class="data-number" id="totalProfit">123,456</p>
