...
public class SysUserDictController {
	 ...
	 * @return
	 */
	@ApiOperation(value="字典数据获取", notes="字典数据获取")
	@RequestMapping(value = "/getDictText", method = RequestMethod.GET)
	public Result<String> getDictText(
	...
	public Result<List<DictModel>> getDictItems(@RequestParam(value = "dictCode",required = true) String dictCode, @RequestParam(value = "sign",required = false) String sign,HttpServletRequest request) {
		log.info(" dictCode : "+ dictCode);
	 ...
	 * @return
	 */
    @RequiresPermissions("cjxt:userDict:add")
	 ...
	 * @return
	 */
    @RequiresPermissions("cjxt:userDict:edit")
	 ...
	 * @return
	 */
    @RequiresPermissions("cjxt:userDict:delete")
	 ...
	 * @return
	 */
    @RequiresPermissions("cjxt:userDict:deleteBatch")
...
//		redisTemplate.delete(keys7);
	 ...
	 * @return
	 */
    @RequiresPermissions("cjxt:userDict:importExcel")
